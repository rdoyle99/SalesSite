...
class EarlierDisplay extends React.Component {
  ...
  componentDidMount() {
    ...
    fetch("https://sheetsu.com/apis/v1.0su/c3d38a3d5efd/sheets/earlier").then((response) => {
        ...
        this.state.data.map(function(row) {
          return <div>
            <li key={row.id} id="hov" class="item">
              ...
              <a href={row.url} target="_blank" title={row.title} id="some-div">

                <div class="topper">

                  <div>

                    <img data-src={row.logo} alt="💰" class="lazyloaded company-picture" src={row.logo}/>
                  </div>
